module Main where
{
    ...
    [
        ...
        evalTest "{b:2,}" (return (ObjectValue (MkObject [("b",NumberValue 2)]))),
        evalTest "{2}" (return (ObjectValue (MkObject [("",NumberValue 2)]))),
        evalTest "{2,}" (return (ObjectValue (MkObject [("",NumberValue 2)]))),
        ...
        -- object selector
        evalTest "{1,b:2}.\"\"" (return (NumberValue 1)),
        ...
        evalTest "{|{|null:_|}: null|}" (return (FunctionValue id)),
        evalTest "{|{|null:a|}: null|}" (return (FunctionValue id)),
        evalTest "{|{|null:{|\"a\":a|}|}: null|}" (return (FunctionValue id)),
        evalTest "{|{|null:{|\"a\":a,\"b\":b|}|}: null|}" (return (FunctionValue id)),
...
--        evalTest "\"a\" 25" (fail "non-function application"),
    ...
    [
        ...
        patternTests "_object" ["{}"] ["null","false","0","\"\"","[]","{||}"],
        patternTests "{}" ["{}","{\"1\":2}"] ["null","false","0","\"\"","[]","{||}"],
        patternTests "{\"1\":2}" ["{\"1\":2}","{\"1\":2,\"1\":4}"] ["null","false","0","\"\"","[]","{}","{||}","{\"1\":3}","{\"1\":null}","{\"2\":2}"],
        patternTests "{a:2}" ["{a:2}","{\"a\":2}","{a:2,a:4}"] ["null","false","0","\"\"","[]","{}","{||}","{a:3}","{a:null}","{b:2}"],
